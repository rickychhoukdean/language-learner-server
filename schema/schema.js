...
mongoose.connect(`mongodb+srv://${process.env.DB_USERNAME}:${process.env.DB_PASSWORD}@cluster0-n6sz5.mongodb.net/test?retryWrites=true&w=majority`, { useNewUrlParser: true });
